                        ...
                        <v-expansion-panel-header expand-icon="mdi-menu-down" @click="handleClick(item)">
                            <v-row>
                                <v-col cols="12" md="6" class="">
                                    <div class="ma-2">
                                        <h4 class="ma-1"><v-icon class="ma-1" color="orange">mdi-calendar-multiple-check</v-icon> EVENTO {{item.nome_aniversariante.toUpperCase()}}</h4>
                                    </div>
                                ...
                                <v-col cols="12" md="6" class="d-flex flex-column align-center justify-center">
                                    <h4 class="ma-1"><v-icon class="ma-1" color="orange">mdi-clipboard-text-clock-outline</v-icon> DATA DO EVENTO {{ $moment(item.data_evento).format('L') }}</h4>
                                </v-col>
                            </v-row>
            ...
            <v-col v-else cols="12" class="d-flex align-center justify-center"> 
                <v-row>
                    <v-col cols="12" class="d-flex align-center justify-center" >
                        <div class="d-flex align-center justify-center flex-column" style="height: calc(100vh - 60px);">
                            <div class="animate__animated animate__pulse animate__infinite	infinite" >
                                <span class="pa-2" style="font-size:25px; color: black;background-color: orange; border-radius: 10px;">
